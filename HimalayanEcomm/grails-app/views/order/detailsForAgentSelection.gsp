    ...
    <div class="row-fluid">
        ...
        <div class="span8">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <g:form controller="order" action="assignAgent" class="form-horizontal" params="[orderId:order?.id]">

                        <div class="control-group">
                            <label for="normal" class="control-label">Agent</label>
                            <div class="controls">
                                <g:select name="agent"  from="${user?.firstName}" class="form-control"></g:select>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="${createLink(controller: 'order',action: 'viewAllOrders')}" class="btn btn-danger">Back</a>
                        </div>
                    </g:form>
                </div>
            </div>
